...
namespace attachmentsDAL
{
    ...
    public class ObjectChangeTracker
    {
        ...
        public HashSet<string> ChangedProperties = new HashSet<string>();
        #endregion
    
        #region Events
    
        public event EventHandler<ObjectStateChangingEventArgs>
          ObjectStateChanging;
    
          #endregion
    
          internal void RecordPropertyChange(string propertyName)
          {
