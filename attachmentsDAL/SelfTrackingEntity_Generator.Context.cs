...
namespace attachmentsDAL
{
    ...
    {
        public const string ConnectionString = "name=attachDBEntities";
        public const string ContainerName = "attachDBEntities";
    
        #region Constructors
    
        public attachDBEntities()
            : base(ConnectionString, ContainerName)
        {
            Initialize();
        }
    
        public attachDBEntities(string connectionString)
            : base(connectionString, ContainerName)
        {
            Initialize();
        }
    
        public attachDBEntities(EntityConnection connection)
