...
namespace Online
{
    ...
    public interface IPrioritizerService
    {
        ...
        [OperationContract]
        void applyChangesMeetingCategory(MeetingCategory mc);
        [OperationContract]
        void deleteMeetings(Meetings m);
        [OperationContract]
        void applyChangesMeetings(Meetings m);
        [OperationContract]
        ...
        [OperationContract]
        List<Tasks> applyChangesTasksList(List<Tasks> changedTasksList, Guid userID);
        [OperationContract]
        ...
        [OperationContract]
        void applyChangesProjects(projects p);
        [OperationContract]
        void deleteUsers(Users u);
        [OperationContract]
        void applyChangesUsers(Users u);
        [OperationContract]
        ...
        [OperationContract]
        IEnumerable<MeetingCategory> getMeetingCategoryList(bool filterCategoriesOnlyForLoggedInUser, Guid userID);
        [OperationContract]
        IEnumerable<Meetings> getMeetingList(Guid meetingCategory, Guid userID, bool includeFinished, Guid? tenantID);
        [OperationContract]
        IEnumerable<Tasks> getTasksForUser(bool includeFinishedTasks, bool includeCancelledTasks, Guid userID);
        [OperationContract]
        ...
        [OperationContract]
        void deleteAttachment(attachments a);
        [OperationContract]
