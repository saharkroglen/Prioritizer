        ...
        private static void UpdateOriginalValues(ObjectContext context, IObjectWithChangeTracker entity)
        {
            if (entity.ChangeTracker.State == ObjectState.Unchanged ||
                ...
                (entity.ChangeTracker.OriginalValues == null &&
    			 entity.ChangeTracker.ChangedProperties.Count == 0))
            {
                // nothing to do here
                return;
            }
            ...
            foreach(EdmProperty property in entityType.Properties)
            {
    			...
    			{
    				if (entity.ChangeTracker.OriginalValues.TryGetValue(property.Name, out value))
    				{
    					originalValueRecord.SetValue(property, value);
    				}
    				else if(entity.ChangeTracker.ChangedProperties.Contains(property.Name))
    				{
    					entry.SetModifiedProperty(property.Name);
    				}
    			}
