...
{  
    //public class PrioritizerMembershipProvider : MembershipProvider
    //{
    //    #region members
    ...
    //    private Online.PrioritizerService _prioritizerService = null;
    //    #endregion
    ...
    //        if (String.IsNullOrEmpty(name)) name = "PrioritizerMembershipProvider";

    //        if (String.IsNullOrEmpty(config["description"]))
    //        {
    //            config.Remove("description");
    //            config.Add("description", "Prioritizer Membership Provider");
    //        }
    ...
    //            using (PrioritizerUnitOfWork uow = _prioritizerService.UnitOfWork)
    //            {
    ...
    //                    userName = username,
    //                    email = email,
    //                    password = Prioritizer.Shared.Utils.EncodePassword(password),
    ...
    //                try
    //                {
    //                    //uow.Context.AddToUser(user);
    //                    uow.Context.Users.ApplyChanges(user);
    //                    uow.Commit();
    ...
    //        try
    //        {
    //            Users user = _prioritizerService.unlockUser(userName);
    //            //EFDataModelEntities context = new EFDataModelEntities(ConnectionString);
    //            //IQueryable<User> users = from u in context.User
    //            //                         where u.Username == userName && u.ApplicationName == applicationName
    //            //                         select u;
    ...
    //        Users user = _prioritizerService.getUserByID((Guid)providerUserKey);
    //        //EFDataModelEntities context = new EFDataModelEntities(ConnectionString);
    //        //IQueryable<User> users = from u in context.User
    ...
    //                _prioritizerService.applyChangesUsers(user, Guid.Empty);
    //            }
    //        }
    ...
    //        List<Users> users = _prioritizerService.getUserByName(username, null).ToList<Users>();
    ...
    //            List<Users> users = _prioritizerService.getUserByEmail(email, null).ToList<Users>();
    ...
    //    {
    //        MembershipUserCollection membershipUsersCollection = new MembershipUserCollection();

    //        //retrieve all users for the current application name from the database
    //        //EFDataModelEntities context = new EFDataModelEntities(ConnectionString);

    //        //totalRecords = (from u in context.User
    //        //                where u.ApplicationName == applicationName
    //        //                select u).Distinct().Count();
    //        //if (totalRecords <= 0) return users;

    //        //IQueryable<User> efUsers = (from u in context.User
    //        //                            where u.ApplicationName == applicationName
    //        //                            orderby u.Username
    ...
    //        List<Users> efUsers = _prioritizerService.getUsers(null).ToList<Users>();
    //        totalRecords = efUsers.Count();
    //        foreach (Users user in efUsers)
    //        {
    //            membershipUsersCollection.Add(GetMembershipUserFromPersitentObject(user));
    //        }
    //        return membershipUsersCollection;
    //    }
    ...
    //        List<Users> usersOnline = _prioritizerService.getUserOnline(compareTime).ToList<Users>();
    ...
    //        //                         orderby u.Username
    //        //                         select u;
    //        List<Users> users = _prioritizerService.findUserByName(usernameToMatch).ToList<Users>();

    //        totalRecords = users.Count();
    //        if (users.Count() <= 0) return membershipUsers;

    //        foreach (Users user in users.Skip(pageIndex * pageSize).Take(pageSize))
    //        {
    ...
    //    private MembershipUser GetMembershipUserFromPersitentObject(Users user)
    //    {
    ...
    //                                  user.Comment,
    //                                  true,
    //                                  Convert.ToBoolean(!user.Activated),
