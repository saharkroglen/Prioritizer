...
namespace Prioritizer.Shared.Model
{
    ...
    public partial class attachments: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public byte[] bin
        {
            ...
            set
            {
                if (_bin != value)
                {
                    ChangeTracker.RecordPropertyChange("bin");
                    _bin = value;
        ...
        public Nullable<System.Guid> taskID
        {
            ...
            set
            {
                if (_taskID != value)
                {
                    ChangeTracker.RecordPropertyChange("taskID");
                    _taskID = value;
        ...
        public string fileName
        {
            ...
            set
            {
                if (_fileName != value)
                {
                    ChangeTracker.RecordPropertyChange("fileName");
                    _fileName = value;
      ...
      if (!IsDeserializing)
      {
        ...
        private void FixupTenant(Tenant previousValue)
        {
            ...
            if (Tenant != null)
            {
                if (!Tenant.attachments.Contains(this))
                {
                    Tenant.attachments.Add(this);
                }
