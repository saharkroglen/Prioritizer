...
namespace Prioritizer.Shared.Model
{
    ...
    public partial class projects: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public string projectName
        {
            ...
            set
            {
                ...
                {
                    ChangeTracker.RecordPropertyChange("projectName");
                    _projectName = value;
      ...
      if (!IsDeserializing)
      {
        ...
        private void FixupTenant(Tenant previousValue)
        {
            ...
            if (Tenant != null)
            {
                if (!Tenant.projects.Contains(this))
                {
                    Tenant.projects.Add(this);
                }
